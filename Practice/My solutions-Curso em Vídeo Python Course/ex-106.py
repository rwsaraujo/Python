...
[EN]
> Make a mini system that uses Python Interactive Help. The user will type the command and the manual will appear. When
the user enters the word 'END', the program will close. Important: Use colors.
"""
from time import sleep
c = ('\033[m',        # 0 - sem cores
     '\033[0;30;41m', # 1 - vermelho
     '\033[0;30;42m', # 2 - verde
     '\033[0;30;43m', # 3 - verde
     '\033[0;30;44m', # 4 - azul
     '\033[0;30;45m', # 5 - roxo
     '\033[7;30m',    # 6 - branco
     );
